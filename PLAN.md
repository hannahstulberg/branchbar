...
| 2026-09-01 | Hannah | APPROVED (plan mode exit) — implementation began 2026-09-01 |
| 2026-09-02 | codex Challenge on the shipping code (pre-ship, Gate 3) | DO NOT SHIP: 2 blockers (sign-in script host injection; scan deadline cannot interrupt a blocked listing), 15 major, 5 minor. Fix wave F1–F3 dispatched; v0.9.0 held as pre-release. See DECISION-LOG. |
| 2026-09-02 | codex Challenge round 2 (after F1–F5, 312 tests) | DO NOT SHIP: 3 blockers (blocked listing still uncancellable → helper process; FIFO/symlink special files; version not bumped), 10 major, 5 minor; 9 round-1 findings closed, 7 partial, 3 open. Second wave F6–F8 dispatched. |
